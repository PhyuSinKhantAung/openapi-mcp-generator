...
var _AppTeam = _interopRequireDefault(require("./AppTeam"));
var _NamespaceActor = _interopRequireDefault(require("./NamespaceActor"));
...
var Namespace = /*#__PURE__*/function () {
   ...
   */
  return _createClass(Namespace, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('team')) {
          obj['team'] = _AppTeam["default"].constructFromObject(data['team']);
        }
        ...
        if (data.hasOwnProperty('actor')) {
          obj['actor'] = _NamespaceActor["default"].constructFromObject(data['actor']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['team']) {
        // data not null
        _AppTeam["default"].validateJSON(data['team']);
      }
      // ensure the json data is a string
      ...
      if (data['actor']) {
        // data not null
        _NamespaceActor["default"].validateJSON(data['actor']);
      }
      // ensure the json data is a string
