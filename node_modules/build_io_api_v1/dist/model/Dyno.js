...
var Dyno = /*#__PURE__*/function () {
   ...
   */
  function Dyno(type, quantity, size, display, processes) {
    _classCallCheck(this, Dyno);
   ...
   */
  return _createClass(Dyno, null, [{
    key: "initialize",
    value: function initialize(obj, type, quantity, size, display, processes) {
      obj['type'] = type;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('processes')) {
          obj['processes'] = _ApiClient["default"].convertToType(data['processes'], [_Process["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(Dyno.RequiredProperties),
        _step;
      try {
      ...
      if (data['processes']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['processes']),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var item = _step2.value;
            _Process["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = exports["default"] = Dyno;